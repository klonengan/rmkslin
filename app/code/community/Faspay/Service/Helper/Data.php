...
class Faspay_Service_Helper_Data extends Mage_Payment_Helper_Data
{
	//Get total price
	...
	public function _bcakp_signature(){
		$user_id	= Mage::getStoreConfig('Service/setting/merchant_id');
		$password	= Mage::getStoreConfig('Service/setting/merchant_name');
