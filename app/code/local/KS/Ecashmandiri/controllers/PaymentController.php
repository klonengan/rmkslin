 ...
 *
 * Custom CIMB Clicks Payment Controller
 * @modified Ryan Permana <rpermana@kemana.com>
 */

require_once(Mage::getBaseDir('lib') . '/veritrans-php/Veritrans.php');

class KS_Ecashmandiri_PaymentController extends Mage_Core_Controller_Front_Action {
...
*/
    ...
    // $cimb = Mage::getSingleton('core/session')->getPaymentData();
