...
/**
 * KS_KSDirectory_Model_Mysql4_Subdistrict_Collection
 *
 * @author      Edi Suryadi <esuryadi@kemanaservices.com>
 */

class KS_KSDirectory_Model_Mysql4_Subdistrict_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract 
{
    protected function _construct()
    {
        parent::_construct();
        $this->_init('ksdirectory/subdistrict');
    }
    ...
    public function loadByCode($subdistrictCode){
