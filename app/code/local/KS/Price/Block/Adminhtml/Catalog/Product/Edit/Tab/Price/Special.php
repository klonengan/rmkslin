<?php
class KS_Price_Block_Adminhtml_Catalog_Product_Edit_Tab_Price_Special
    extends Mage_Adminhtml_Block_Catalog_Product_Edit_Tab_Price_Group_Abstract
{
    ...
    {
        $this->setTemplate('ksprice/product/edit/price/special.phtml');
    }
    ...
    protected function _prepareLayout()
    {
        $button = $this->getLayout()->createBlock('adminhtml/widget_button')
            ->setData(array(
                'label' => Mage::helper('catalog')->__('Add Warehouse Special Price'),
                'onclick' => 'return warehouseSpecialPriceControl.addItem()',
                'class' => 'add'
            ));
        $button->setName('add_warehouse_special_price_item_button');
	...
	public function getValues(){
		return Mage::getModel('ksprice/special')->getWarehousePrices($this->getProduct());
	}
